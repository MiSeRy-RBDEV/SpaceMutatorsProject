...
class Player(pygame.sprite.Sprite):
    ...
    def draw_health_bar(self, surface):
        ...
        outline_rect = pygame.Rect(self.rect.centerx - bar_length//2, self.rect.bottom - 20, bar_length, bar_height)
        fill_rect = pygame.Rect(self.rect.centerx - bar_length//2, self.rect.bottom - 20, fill, bar_height)
